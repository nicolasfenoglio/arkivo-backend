/**
 * Los middlewares son funciones que se ejecutan durante el ciclo de vida de una solicitud HTTP en una aplicación Express.
 * Estas funciones pueden modificar la solicitud (req) y la respuesta (res), o incluso finalizar el ciclo de solicitud-respuesta.
